...
## Step 3 — Audit all CSS for hardcoded values
...
Only replace values that have a direct token equivalent. If a value is genuinely project-specific (e.g. a brand colour not in the token set), leave it and note it in the report.

## Step 4 — Replace custom component styles with classes
...
| Status badge | `.badge` + `.badge-success` / `.badge-danger` |
| Page wrapper | `.container` |

## Step 5 — Delete redundant CSS rules
...
## Step 6 — Do not touch application logic
...
## Step 7 — Output a migration report
